export default {
  pl: {
    from: 'reduxonJSX@gmail.com',
    subject: '-userName- patrz co udało mi się zapamiętać!',
    html: `
            <p> Hej -userName- tutaj Reduxon! </p>
            <div style="height:5px"></div>
            <p>Zgodnie z obietnicą przesyłam informacje jakie udało mi się zapamiętać. 😉</p>
            <p>Więc tak, masz na imię -userName- ,</p>
            <p>Twoja miejscowość zamieszkania to -userOrigin- </p>
            <p>hobby jakie uprawiasz w wolnym czasie to -userHobby- </p>
  ...
  eng: {
    ...
    html: `
            <p> Hey -userName-, this is Reduxon! </p>
            <div style="height:5px"></div>
            <p>As promised, I am sending information that I can remember. 😉</p>
            <p>So yeah, Your name is -userName-,</p>
            <p>Your city of residence is -userOrigin-,</p>
            <p>the hobby You do in Your spare time is -userHobby-, </p>
